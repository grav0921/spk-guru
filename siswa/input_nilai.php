<?php
	...
	$cek = mysql_query("select * from nilai_siswa where nis='$nis' and id_guru='$id_gur'");
	$num = mysql_num_rows($cek);
	if ($num > 0 ){
		$query = "update nilai_siswa set q1='$q1', q2='$q2', q3='$q3', q4='$q4', avg='$rata' where nis='$nis' and id_guru='$id_gur'";
	}else{
		$query = "insert into nilai_siswa values ('', '$nis', '$id_gur', '$q1', '$q2', '$q3', '$q4', '$rata')";
	}

	$sql = mysql_query($query);

	$j_sql = mysql_query("select * from nilai_siswa where id_guru = '$id_gur'");
